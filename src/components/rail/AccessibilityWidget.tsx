              ...
              <div className="space-y-3 bg-muted/30 p-4 rounded-xl border">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-xs font-bold text-primary">
                    {prefs.lowSaturation === 0 ? "Grayscale" : prefs.lowSaturation === 50 ? "Low" : "Normal"}
                  </span>
                </div>
                <div className="flex gap-2">
                  {[0, 50, 100].map((val) => (
              ...
              {prefs.adhdMode && (
                <div className="mt-4 p-4 bg-muted/40 rounded-xl border border-primary/20 space-y-4 animate-in fade-in slide-in-from-top-4 duration-200">
                  ...
                  <div className="space-y-2">
                    <div className="text-[11px] font-bold text-muted-foreground uppercase">Reading Band Height</div>
                    <div className="flex gap-2">
                      {(["small", "medium", "large"] as const).map((size) => (
                        ...
                        >
                          {size === "small" ? "Small (80px)" : size === "large" ? "Large (220px)" : "Medium (150px)"}
                        </button>
                      ))}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      onClick={() => savePrefs({ ...prefs, adhdHighlightParagraph: !prefs.adhdHighlightParagraph })}
...
function ToggleButton({
  ...
  return (
    ...
    >
      <div className={`p-1.5 rounded-lg mb-1.5 ${isActive ? "bg-primary text-primary-foreground" : "bg-muted/40"}`}>
        {icon}
      </div>
