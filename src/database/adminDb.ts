...
const DEFAULT_RULES: AdminRule[] = [
  {
    ...
    ruleNumber: "Rule 49",
    description:
      "Requires minimum 10 years of qualifying service under defined pension schemes (OPS/UPS).",
    applicableRetirementTypes: [
      "Normal Retirement",
  ...
  },
  {
    ...
    description:
      "Admissible pension is computed at 50% of the last basic pay or average of the last 10 months, whichever is more beneficial.",
    applicableRetirementTypes: [
      "Normal Retirement",
      "Voluntary Retirement",
      "Compulsory Retirement",
  ...
  },
  {
    ...
    ruleNumber: "Rule 54",
    description:
      "Family pension admissible to eligible legal heirs (spouse, children, dependent parents) on employee demise.",
  ...
  },
  {
    ...
    description:
      "Enhanced family pension payable at 50% of basic pay (instead of 30%) for 10 years or until age 67, whichever is earlier.",
    applicableRetirementTypes: ["Death"],
    applicableScheme: "OPS & UPS",
    status: "Active",
    ruleReference: "RBE No. 12/2021",
  },
  {
    ...
    description:
      "Computed at 1/4 of monthly emoluments (Basic + DA) per completed six-month service, subject to a statutory cap of ₹20,00,000.",
    applicableRetirementTypes: [
      "Normal Retirement",
      "Voluntary Retirement",
      "Compulsory Retirement",
  ...
  },
  {
    ...
    description:
      "Admissible cash equivalent of leave salary for accumulated Earned Leave (LAP) and Half Pay Leave (LHAP) up to 300 days.",
    applicableRetirementTypes: [
      "Normal Retirement",
      "Voluntary Retirement",
      "Compulsory Retirement",
  ...
  },
  {
    ...
    description:
      "Enables withdrawal of full GPF credit or NPS corpus exit guidelines (60% lump sum, 40% mandatory annuity).",
    applicableRetirementTypes: [
      "Normal Retirement",
      "Voluntary Retirement",
      "Compulsory Retirement",
  ...
  },
  {
    ...
    description:
      "Payment of savings component and insurance component as per employee's subscription group slabs.",
    applicableRetirementTypes: [
      "Normal Retirement",
      "Voluntary Retirement",
      "Compulsory Retirement",
  ...
  },
  {
    ...
    description:
      "Retiring railway employees with 20+ years of service are eligible for life-long free medical facilities under RELHS-97.",
    applicableRetirementTypes: [
      "Normal Retirement",
      "Voluntary Retirement",
      "Compulsory Retirement",
  ...
  },
  {
    ...
    description:
      "Admissible Post-Retirement Complimentary Passes (PRCP) based on employee's group and length of service.",
    applicableRetirementTypes: [
      "Normal Retirement",
      "Voluntary Retirement",
      "Medical Invalidation",
...
const DEFAULT_FORMULAS: AdminFormula[] = [
  ...
  },
  {
    ...
    completeFormula:
      "Min(20,00,000, 0.25 * (Basic Pay + Dearness Allowance) * Qualifying half-years)",
...
const DEFAULT_BENEFITS: AdminBenefit[] = [
  ...
  },
  {
    ...
    name: "Leave Encashment",
    eligibility:
      "Paid for accumulated Earned Leave (LAP) and Half Pay Leave (LHAP) up to 300 days.",
  ...
  },
  {
    ...
    requiredDocuments: [
      "Death Certificate",
      "Form 14",
      "Joint Photo of Spouse/Legal Heir",
      "Active bank credentials",
    ],
    ruleReference: "Rule 54 / R310",
    status: "Active",
  },
  {
    ...
    eligibility:
      "Retiring railway employee with 20+ years of service (one-time fee equivalent to 1 month basic).",
    ...
    requiredDocuments: [
      "RELHS Application Form",
      "Medical Option Card (Form Med-2)",
      "Two passport size joint photos",
    ],
...
const DEFAULT_UPDATES: RecentUpdate[] = [
  {
    id: "1",
    title: "Railway Board Circular (RBE No. 09/2023) uploaded",
    type: "Circular",
    date: "2026-07-10",
  },
  {
    id: "2",
    title: "Formula Library Version updated to v2.4.1",
    type: "Formula",
    date: "2026-07-08",
  },
  {
    id: "3",
    title: "Rule Book (Rule 49 & Rule 50) updated for Unified Pension Scheme (UPS)",
    type: "Rule Book",
    date: "2026-07-01",
  },
  {
    id: "4",
    title: "RELHS Medical Contribution guidelines revised",
    type: "Circular",
    date: "2026-06-25",
  },
];
