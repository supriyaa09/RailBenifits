...
export function evaluateBenefits(input: BenefitInput): EvaluationOutput {
  ...
  if (caseType === "retirement") {
    ...
    trace.push(
      pensionEligible
        ? "Rule R101 (Qualifying Service ≥ 10y) ✔"
        : "Rule R101 (Qualifying Service ≥ 10y) ✗",
    );
  ...
  if (caseType === "death") {
    ...
    results.push({
      ...
      amount: validRel
        ? `${money(Math.round(basicPay * 0.3))} / month (30% of last basic, enhanced 50% for 10y)`
        : undefined,
  ...
  const gratuityAmt = gratuityEligible
    ? Math.min(2000000, Math.round((emoluments * years) / 4))
    : 0;
  results.push({
  ...
  results.push({
    ...
    amount:
      caseType !== "removal"
        ? `${money(Math.round(emoluments * 10))} (approx. 300 days)`
        : undefined,
  ...
  results.push({
    ...
    reason:
      scheme === "NPS"
        ? "NPS corpus withdrawable per PFRDA guidelines (60% lumpsum, 40% annuity)."
        : "Full GPF balance with interest is payable.",
...
export const CIRCULARS = [
  {
    id: "RBE-45-2022",
    name: "Revised Pension Rules 2022",
    date: "2022-08-12",
    category: "Pension",
    summary: "Revised computation methodology for retirement pension under OPS/UPS.",
    status: "Active",
  },
  {
    id: "RBE-12-2021",
    name: "Family Pension Guidelines",
    date: "2021-03-04",
    category: "Family Pension",
    summary: "Consolidated guidelines for family pension including enhanced rates.",
    status: "Active",
  },
  {
    id: "RBE-78-2020",
    name: "Gratuity Rules Amendment",
    date: "2020-11-19",
    category: "Gratuity",
    summary: "Ceiling revised to ₹20,00,000 with computation clarifications.",
    status: "Active",
  },
  {
    id: "RBE-22-2019",
    ...
    date: "2019-05-22",
    category: "Leave",
    summary: "Encashment of up to 300 days of earned leave.",
    status: "Active",
  },
  {
    id: "RBE-09-2023",
    name: "PF Withdrawal SOP",
    date: "2023-02-17",
    category: "PF",
    summary: "Standard operating procedure for GPF and NPS withdrawal.",
    status: "Active",
  },
  {
    id: "RBE-11-2018",
    name: "CGEGIS Subscription Slabs",
    date: "2018-07-08",
    category: "Insurance",
    summary: "Group-wise subscription and payout tables.",
    status: "Active",
  },
  {
    id: "RBE-55-2017",
    name: "RELHS Scheme Details",
    date: "2017-09-30",
    category: "Medical",
    summary: "Eligibility and enrolment for RELHS post-retirement.",
    status: "Active",
  },
  {
    id: "RBE-33-2022",
    name: "Passes & PTOs Manual",
    date: "2022-01-15",
    category: "Passes",
    summary: "Complimentary pass entitlements by group and service length.",
    status: "Active",
  },
];
...
export const RULES = [
  {
    ...
    caseType: "Retirement",
    conditions: "Service ≥ 10 years, scheme in {OPS, UPS}",
    docs: "Service Book, Form 5",
    circular: "RBE-45-2022",
    effective: "2022-08-12",
    status: "Active",
  },
  {
    id: "R203",
    name: "Pension Computation",
    caseType: "Retirement",
    conditions: "Pension = 50% of last basic pay",
    docs: "PPO Application",
    circular: "RBE-45-2022",
    effective: "2022-08-12",
    status: "Active",
  },
  {
    ...
    caseType: "Death",
    conditions: "Legal heir per Rule 54 CCS (Pension)",
    docs: "Form 14, Legal Heir Cert.",
    circular: "RBE-12-2021",
    effective: "2021-03-04",
    status: "Active",
  },
  {
    id: "R312",
    ...
    caseType: "Death",
    conditions: "50% for first 10y / until age 67",
    docs: "Form 14",
    circular: "RBE-12-2021",
    effective: "2021-03-04",
    status: "Active",
  },
  {
    ...
    caseType: "Retirement/Death",
    conditions: "Emoluments × 1/4 × completed 6-month periods; cap ₹20L",
    docs: "Form 6, Nomination",
    circular: "RBE-78-2020",
  ...
  },
  {
    ...
    caseType: "Retirement/Death",
    conditions: "Max 300 days EL encashable",
    docs: "Leave Account",
    circular: "RBE-22-2019",
    effective: "2019-05-22",
    status: "Active",
  },
  {
    id: "R601",
    name: "PF / NPS Withdrawal",
    caseType: "All",
    conditions: "GPF full or NPS 60/40",
    docs: "Withdrawal Form",
    circular: "RBE-09-2023",
  ...
  },
  {
    ...
    name: "GIS Payout",
    caseType: "All",
    conditions: "Group-wise savings + insurance",
    docs: "GIS Form",
    circular: "RBE-11-2018",
    effective: "2018-07-08",
    status: "Active",
  },
  {
    id: "R810",
    name: "RELHS Eligibility",
    caseType: "Retirement",
    conditions: "Service ≥ 20 years",
    docs: "RELHS Form",
    circular: "RBE-55-2017",
    effective: "2017-09-30",
    status: "Active",
  },
  {
    id: "R905",
    name: "Complimentary Passes",
    caseType: "Retirement",
    conditions: "Service ≥ 20y; not removed",
    docs: "Pass Application",
    circular: "RBE-33-2022",
...
export const SCHEMES = [
  {
    code: "OPS",
    name: "Old Pension Scheme",
    desc: "Defined-benefit pension: 50% of last drawn basic pay for employees appointed before 01-Jan-2004.",
    features: [
      "Guaranteed monthly pension",
      "Family pension to legal heirs",
      "DA-linked revisions",
    ],
  },
  {
    ...
    desc: "Defined-contribution scheme (10% employee + 14% employer) regulated by PFRDA.",
    features: [
      "Market-linked returns",
      "Portable across sectors",
      "60% lumpsum + 40% annuity on exit",
    ],
  },
  {
    code: "UPS",
    name: "Unified Pension Scheme",
    desc: "Assured pension scheme (2025) blending features of OPS and NPS for eligible central employees.",
    features: ["Assured 50% pension after 25y", "Minimum ₹10,000 pension", "Family pension @ 60%"],
  },
];

export const FAQS = [
  {
    q: "What is the minimum service required for pension?",
    a: "10 years of qualifying service is required for pension under OPS/UPS.",
  },
  {
    q: "Is gratuity taxable?",
    a: "Gratuity received by government employees is fully exempt from income tax.",
  },
  {
    q: "Who is eligible for Family Pension?",
    a: "Spouse, dependent children, and dependent parents as defined under Rule 54.",
  },
  {
    q: "How many days of leave can be encashed?",
    a: "Up to 300 days of earned leave can be encashed at retirement/death.",
  },
  {
    q: "What is RELHS?",
    a: "Railway Employees Liberalised Health Scheme provides medical facilities post-retirement.",
  },
  {
    q: "Can NPS subscribers get OPS pension?",
    a: "No, unless they opt for UPS as per the 2025 guidelines and meet the eligibility criteria.",
  },
];

export const DOCS = [
  {
    name: "RBE-45-2022-Pension.pdf",
    uploaded: "2022-08-12",
    size: "1.2 MB",
    category: "Pension",
    status: "Indexed",
  ...
  {
    name: "Family-Pension-Guidelines.pdf",
    uploaded: "2021-03-04",
    size: "890 KB",
    category: "Family Pension",
    status: "Indexed",
...
export const LOGS = [
  {
    ts: "2025-07-06 14:22",
    user: "officer.rao",
    action: "Updated Rule R203 (Pension Computation)",
    level: "info",
  },
  {
    ts: "2025-07-06 12:04",
    user: "officer.mehta",
    action: "Uploaded circular RBE-09-2023",
    level: "info",
  },
  {
    ts: "2025-07-05 18:11",
    user: "system",
    action: "Reindexed circular knowledge base",
    level: "info",
  },
  {
    ts: "2025-07-05 09:47",
    user: "employee.42918",
    action: "Ran benefits check (Retirement, UPS)",
    level: "info",
  },
  {
    ts: "2025-07-04 16:33",
    user: "officer.rao",
    action: "Deactivated Rule R220 (legacy)",
    level: "warn",
  },
];
